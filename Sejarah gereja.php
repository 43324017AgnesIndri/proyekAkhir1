...
<head>
  ...
  <style>
    ...
    .content3 {
      line-height: 1.6;
      font-size: 18px;
      /* Memperbesar paragraf */
      text-align: justify;
      text-indent: 30px;
      /* Mengindentasi baris pertama paragraf */
      line-height: 1.6;
      /* Menjaga jarak antar baris agar lebih nyaman dibaca */
    }
      ...
      <div class="row margin-bottom-40">
        ...
        <div class="col-md-8">
          <div class="container3">
            <center>
              <h1><strong>Sejarah Gereja</strong></h1>
            </center>
            ...
            <div class="content3">
              ...
              <p>Manghilalahon hinaringkot ni panogunon ni Debata marhite huriaNa di Lumban Bulbul on,
              ...
              <p>Arisan Marpaung (+) dohot di bagas ni halak amanta Op. Humisar Marpaung,
              ...
              <p>Ala dang adong be dapot tano sahat tu Lumban Ginabean laho partapahan ni gareja,
              ...
              <p>Ia pangituai ni horja hathia i (pihak I / yang menyerahkan) ima : Op. Basa Simangunsong (+),
                ...
                /Op. Jeremy Simangunsong (+). Na di ketahui Kepala Desa Lumban Bulbul ima halak amanta Bistok
                Simangunsong
                (Op. Balata doli), jala pihak II / yang menerima hathia i ima HS Gultom (Guru Jemaat HKBP Balige),
                St. J. Sihotang (Parhalado Par artaon) jala ditolopi Pandita Ressrot Balige hathia i ima Pdt. A.
                Naiborhu
